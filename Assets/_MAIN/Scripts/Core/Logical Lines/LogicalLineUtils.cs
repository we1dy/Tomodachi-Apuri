...
namespace DIALOGUE.LogicalLines
{
    public static class LogicalLineUtils
    {
        public static class Encapsulation
        {
            ...
            public static EncapsulatedData RipEncapsulationData(Conversation conversation, int startingIndex, bool ripHeadersAndEncapsulators = false)
            {
                ...
                for (int i = startingIndex; i < conversation.Count; i++)
                {
                    ...
                    if (ripHeadersAndEncapsulators || (encapsulationDepth > 0 && !IsEncapsulationEnd(line)))
                        data.lines.Add(line);
        ...
        public static class Expressions
        {
            ...
            public static readonly string REGEX_ARITMATIC = @"([-+*/=]=?)";
